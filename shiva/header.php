...
<div class="header">	
	<div class="wrap"> 
		<div class="header-top">
			 <div class="logo">
                             <a href="index.php"><img style="max-height: 105px;" src="images/intro-logo.png" alt=""></a>
			 </div>
			 <div class="cart">
		...
		<div id='cssmenu'>
			<ul>
			   ...
			   <li <?php if($url == 'about'){ ?> class='active'<?php } ?>><a  href='about.php'><span>About</span></a></li>
                           <li <?php if($url == 'projects'){ ?> class='active'<?php } ?> class='has-sub'><a href='projects.php'><span>projects</span></a>
<!--			      <ul>
                                  <li class='has-sub'><a href='projects.php'><span>Service 1</span></a></li>
                                  <li class='has-sub'><a href='projects.php'><span>Service 2</span></a></li>
			      </ul>-->
			   </li>
